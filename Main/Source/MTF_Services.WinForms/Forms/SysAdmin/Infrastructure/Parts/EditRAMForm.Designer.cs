namespace MTF_Services.WinForms.Forms.SysAdmin.Infrastructure.Parts
{
    partial class EditRAMForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(EditRAMForm));
            ...
            this.toolTip.SetToolTip(this.pictureBox2, "Удалить выбранный тип памяти");
            ...
            this.toolTip.SetToolTip(this.pictureBox3, "Поиск типа памяти");
            ...
            this.toolTip.SetToolTip(this.pictureBox5, "Редактирование типов памяти");
            ...
            this.comboBox2.DataBindings.Add(new System.Windows.Forms.Binding("SelectedValue", this.rAMBindingSource, "RamTypeId", true));
            this.comboBox2.DataSource = this.ramTypeBindingSource;
            this.comboBox2.DisplayMember = "Name";
            this.comboBox2.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
            this.comboBox2.FormattingEnabled = true;
            this.comboBox2.Location = new System.Drawing.Point(187, 107);
            ...
            // rAMBindingSource
            // 
            this.rAMBindingSource.DataSource = typeof(MTF_Services.Model.RAM);
            // 
            // ramTypeBindingSource
            // 
            this.ramTypeBindingSource.DataSource = typeof(MTF_Services.Model.RamType);
            this.ramTypeBindingSource.CurrentChanged += new System.EventHandler(this.ramTypeBindingSource_CurrentChanged);
            // 
            // label3
            // 
            ...
            this.textBox1.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.rAMBindingSource, "Model", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged));
            ...
            this.textBox3.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.rAMBindingSource, "Price", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged, null, "N2"));
            ...
            this.comboBox1.DataBindings.Add(new System.Windows.Forms.Binding("SelectedValue", this.rAMBindingSource, "ManufacturerId", true));
            ...
            this.label4.Text = "Объем модуля (ГБ)";
            // 
            // numericUpDown1
            // 
            this.numericUpDown1.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Left | System.Windows.Forms.AnchorStyles.Right)));
            this.numericUpDown1.DataBindings.Add(new System.Windows.Forms.Binding("Value", this.rAMBindingSource, "Volume", true));
            this.numericUpDown1.Location = new System.Drawing.Point(187, 150);
            ...
            this.Text = "Создание оперативной памяти";
            this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.EditRAMForm_FormClosing);
